...
const Home = () => {
  ...
  // Other methods (handleEmployeeChange, handleUnitChange, handleValueChange, addPenalty, save, etc.) remain the same as before, 
  // but they should be updated to use employees instead of props.employees.

  return (
    <div className="container">
      {/* Loading indicator while fetching employees */}
      {isFetchingEmployees && <div>Loading employees...</div>}

      {/* Form for entering multiple penalties */}
      {  (
        <div className="row">
          <div className="col-md-4">
            <div className="portlet portlet-boxed">
              ...
              <form className="portlet-body" /* onSubmit={addPenalty}*/>
                <div className="form-group">
                  <label htmlFor="exampleInputEmail1">Employee</label>
                  <Select
                    name="employee"
            ...
            <div className="portlet portlet-boxed">
              ...
              {penalties.length === 0 && (
                <div className="portlet-body no-penalties__wrapper">
                  ...
                  <p className="no-data">
                    There are no penalties added at the moment! <br />
                    You can add them by filling out the form on the left.
                  </p>
                </div>
              )}
              {/* Display penalties list */}
              {penalties.length > 0 && (
                <div className="portlet-body penalties__wrapper">
                  <table className="table table-striped">
                    <thead>
